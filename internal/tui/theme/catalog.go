...
func Builtin(name string) Palette {
	...
	default:
		return Palette{
			...
			AccentColor:       "#534AB7",
			AccentSoftColor:   "#7F77DD",
			TextColor:         "#E8E8E3",
			MutedColor:        "#888888",
			SubtleColor:       "#3A3A38",
			ChipBgColor:       "#333331",
			InlineCodeBgColor: "#252523",
			PinnedNoteColor:   "#7F77DD",
			SyncedNoteColor:   "#1D9E75",
			UnsyncedNoteColor: "#888888",
			SyncingNoteColor:  "#7F77DD",
			SharedNoteColor:   "#534AB7",
			MarkedItemColor:   "#D7AF5F",
			ErrorColor:        "#D75F5F",
			SuccessColor:      "#1D9E75",
			SelectedBgColor:   "#302A80",
			SelectedFgColor:   "#FFFFFF",
			HighlightBgColor:  "#2A2466",
		}
	}
}
