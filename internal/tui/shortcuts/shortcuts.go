...
func HelpEntries(m Map) []HelpEntry {
	...
	return []HelpEntry{
		...
		{Section: "Tree", Key: m.SelectSyncProfile.Help().Key, Desc: "Select default sync profile"},
		...
		{Section: "Global", Key: m.ShowThemePicker.Help().Key, Desc: "Open theme picker (live preview, esc to cancel)"},
